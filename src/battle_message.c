...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_LIBRAEVOREACTING]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s karma is reacting to the battle!"),
    [STRINGID_LIBRAEVOEVOLVED]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has Libra Evolved into {B_BUFF1}!"),
