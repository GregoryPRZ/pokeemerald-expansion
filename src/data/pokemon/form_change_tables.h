...
static const struct FormChange sCorviknightFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_LIBRA_EVOLUTION_POSITIVE,    SPECIES_CORVIKNIGHT_LIBRA_POSITIVE},
    {FORM_CHANGE_BATTLE_LIBRA_EVOLUTION_NEGATIVE,    SPECIES_CORVIKNIGHT_LIBRA_NEGATIVE},
#endif
#if P_GIGANTAMAX_FORMS
