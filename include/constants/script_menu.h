...
enum
{
    ...
    MULTI_EMERALD_TOWER_BATTLE_MUSIC,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_EMERALD,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_FRLG,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_DPPT,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_DPPT_LEGEND,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_HGSS,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_HGSS_KANTO,
    MULTI_EMERALD_TOWER_BATTLE_MUSIC_HGSS_LEGEND,
    MULTI_EMERALD_TOWER_BATTLE_CATEGORY,
    MULTI_EMERALD_TOWER_HOENN_LEADERS,
    MULTI_EMERALD_TOWER_HOENN_LEAGUE,
};
