...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_TRICEPHALY = 313,
    ABILITY_WUXI_FINGER_HOLD = 314,
    ABILITY_MEGA_SOL = 315,
    ABILITY_PREDATOR = 316,
    ABILITY_FIGHT_SPIRIT = 317,
    ABILITY_SPICY_SPRAY = 318,
    ABILITY_RESILIENT = 319,
    ABILITY_FIRE_MANE = 320,
    ABILITY_EELEVATE = 321,
